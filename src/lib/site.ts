...
/** หน้า GitHub Sponsors — ว่างไว้ = ซ่อนปุ่มในหน้า /support (ใส่ 'https://github.com/sponsors/bignutchanon' หลังโปรไฟล์ผ่านรีวิว) */
export const GITHUB_SPONSORS_URL = ''
/** Google Tag Manager container — สคริปต์ใน layout.tsx อ่านค่านี้ ว่างไว้ = ไม่โหลด GTM */
export const GTM_ID = 'GTM-TF6NW7LG'
...
// ปลายทางปุ่ม "แนะนำ" = Cloudflare Worker + D1 (ดูโค้ดและวิธี deploy ใน worker/README.md)
// เว็บเป็น static export จึงเก็บยอดเองไม่ได้ ต้องยิงข้ามโดเมนจากเบราว์เซอร์
// ว่าง = ปิดระบบ → <RecommendButton> ไม่ถูก render ทั้งหมด
