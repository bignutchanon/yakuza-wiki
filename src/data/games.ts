...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://drive.google.com/file/d/1lnzsDecmbP477SU_PO3wzhu5zfIZ8DdC/view?usp=sharing',
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://drive.google.com/file/d/1KKNfaz2ajhrYyu539i2s0AR7Vzu0aWxW/view?usp=sharing',
      note: 'v1.0.2 (29 ส.ค. 2026) — แก้ตัวอักษรเพี้ยนในป้ายเริ่มต่อสู้/เทลอปคัตซีน (คนที่โหลด v1.0.1 ให้เปลี่ยนมาใช้ตัวนี้)',
      version: 'v1.0.2',
      updated: '2026-08-29',
    },
  },
