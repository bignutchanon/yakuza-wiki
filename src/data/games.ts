...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.6/LostJudgmentThai-th-v1.0.6.zip',
      note: 'v1.0.6 (10 ก.ย. 2026) — แก้ซับรำพึงของยากามิในบทที่ 3 กับรายการเป้าหมายในแถบ "ค้นหาแอคทีฟ" ที่ตัวอักษรเรียงลงมาแนวตั้งจนอ่านไม่ได้ ติดตั้งทับได้เลย',
      version: 'v1.0.6',
      updated: '2026-09-10',
    },
  },
