...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.9/LostJudgmentThai-th-v1.0.9.zip',
      nexus: 'https://www.nexusmods.com/lostjudgment/mods/800',
      note: 'v1.0.9 (22 ก.ย. 2026) — แก้ป้ายในผังความสัมพันธ์ชมรมและกล่องบทสนทนาขณะเดินคุยที่เรียงตัวอักษรแนวตั้ง + สะกดฮามากิตะให้ตรงกันทั้งเกม ติดตั้งทับได้เลย',
      version: 'v1.0.9',
      updated: '2026-09-22',
    },
  },
