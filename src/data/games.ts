...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.3/LostJudgmentThai-th-v1.0.3.zip',
      note: 'v1.0.3 (30 ส.ค. 2026) — แก้ป้ายหัวข้อในเมนูมินิเกมที่ขึ้นเป็นตัวอักษรละตินอ่านไม่ออก (ชัดสุดที่จอเลือกเพลงชมรมเต้น) ติดตั้งทับได้เลย',
      version: 'v1.0.3',
      updated: '2026-08-30',
    },
  },
