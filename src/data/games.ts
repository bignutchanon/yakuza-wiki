...
export const GAMES: Game[] = [
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/like-a-dragon-ishin-thai-mod/releases/download/v1.2/LikeADragonIshinThai-v1.2.zip',
      note: 'v1.2 (6 ก.ย. 2026) — แก้ชื่อศัตรูลูกกระจ๊อกบนแถบพลังที่ยังขึ้นเป็น ?????? ใน v1.1 (แสดงเป็นโรมาจิเหมือนเวอร์ชันอังกฤษ) · ตั้งภาษาข้อความในเกมเป็น English',
      version: 'v1.2',
      updated: '2026-09-06',
    },
  },
