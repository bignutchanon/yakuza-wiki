...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/judgment-thai/releases/download/v1.1.1/JudgmentThai-th-v1.1.1.zip',
      note: 'v1.1.1 (5 ก.ย. 2026) — แก้ข้อความล้นกรอบใน CASE FILE · หัวข้อเมนูโดรน · ซับแปลกใน MV เปิดเกม · สระอำ · คำลงท้ายผิดเพศ ติดตั้งทับได้เลย เซฟเดิมใช้ต่อได้',
      version: 'v1.1.1',
      updated: '2026-09-05',
    },
  },
