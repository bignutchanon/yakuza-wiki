...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.4/LostJudgmentThai-th-v1.0.4.zip',
      note: 'v1.0.4 (1 ก.ย. 2026) — แก้ข้อความในจอมินิเกมที่ยังขึ้นเป็นตัวอักษรละตินอ่านไม่ออก (จอสรุปผลชมรมเต้น เมนูโดรน คาสิโน ยิงซอมบี้) ติดตั้งทับได้เลย',
      version: 'v1.0.4',
      updated: '2026-09-01',
    },
  },
