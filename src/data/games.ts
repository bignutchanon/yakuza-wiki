...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      ...
      note: "v1.9 (22 ก.ย. 2026) — เกลาคำแปลบทสนทนาทั้งเกม (เนื้อเรื่อง · ซับสตอรี่ · คาบาเรต์คลับ) + แก้ตัวละครพูดผิดเพศ + ชื่อเฉพาะตรงกันทั้งเกม · รองรับ Yakuza 0 Director's Cut · ติดตั้ง: ปิดเกม แตกไฟล์ zip แล้วลากโฟลเดอร์ runtime ไปวางทับในโฟลเดอร์เกม (Steam → Manage → Browse local files) ตอบ Merge/Replace แล้วเปิดเกมได้เลย",
      version: 'v1.9',
      updated: '2026-09-22',
