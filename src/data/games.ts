...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/yakuza0-dc-thai-mod/releases/download/v1.8.1/Yakuza0DC_Thai_v1.8.1.zip',
      note: "v1.8.1 (18 ก.ย. 2026) — แก้เกมเด้งตอนกด Check ในเควสสาวสรรพากร + แปลป้ายตัวเลือกเกือบ 700 จุด (เมนูคาสิโน/มินิเกม/ตัวเลือกซับสตอรี่) · รองรับ Yakuza 0 Director's Cut · ติดตั้ง: ปิดเกม แตกไฟล์ zip แล้วลากโฟลเดอร์ runtime ไปวางทับในโฟลเดอร์เกม (Steam → Manage → Browse local files) ตอบ Merge/Replace แล้วเปิดเกมได้เลย",
      version: 'v1.8.1',
      updated: '2026-09-18',
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/judgment-thai/releases/download/v1.1.4/JudgmentThai-th-v1.1.4.zip',
      nexus: 'https://www.nexusmods.com/judgment/mods/365',
      note: 'v1.1.4 (15 ก.ย. 2026) — แก้อาการเกมค้าง/not responding ระหว่างเล่น (รวม VR Dice & Cube ค้างครั้งแรก) คำแปลเหมือน v1.1.3 ติดตั้งทับได้เลย เซฟเดิมใช้ต่อได้',
      version: 'v1.1.4',
      updated: '2026-09-15',
    },
  },
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.10/LostJudgmentThai-th-v1.0.10.zip',
      nexus: 'https://www.nexusmods.com/lostjudgment/mods/800',
      note: 'v1.0.10 (22 ก.ย. 2026) — กันตัวอักษรเรียงแนวตั้งทั้งเกม (คู่มือ · คำอธิบายไอเทม · ชิ้นส่วนโดรน · มินิเกม · ตัวเลือกในฉากสืบสวน) ไม่ต้องรอแจ้งทีละจอ ติดตั้งทับได้เลย',
      version: 'v1.0.10',
      updated: '2026-09-22',
    },
  },
