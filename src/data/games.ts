...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    trailer: 'AKrZgO-bqB4',
    maps: ['kamurocho'],
    protagonists: ['ทาคายูกิ ยางามิ', 'มาซาฮารุ ไคโตะ'],
    setting: 'คามุโรโจ (โตเกียว) — ค.ศ. 2018',
    blurb:
      'ทาคายูกิ ยางามิ ทนายที่ชื่อเสียงพังทั้งวงการหลังคดีหนึ่ง ผันตัวมาเปิดสำนักงานนักสืบเล็ก ๆ ในคามุโรโจ แล้วถูกลากเข้าคดีฆาตกรรมต่อเนื่องที่เหยื่อทุกรายถูกควักลูกตา — สปินออฟแนวสืบสวนที่เอาการต่อสู้แบบซีรีส์มาผสมกับงานสะกดรอย ตามหาเบาะแส และการว่าความในศาล',
    mod: { status: 'none' },
  },
  {
    id: 'y7',
  ...
  },
  {
    ...
    blurb:
      'ตำรวจคนหนึ่งสารภาพกลางศาลว่าเขาฆ่าคน ทั้งที่ตอนเกิดเหตุเขานั่งอยู่ในห้องพิจารณาคดีอีกเมืองหนึ่ง — คำสารภาพนั้นลากยางามิเข้าไปในคดีกลั่นแกล้งของโรงเรียนมัธยมในโยโกฮาม่าที่จบลงด้วยการฆ่าตัวตาย และคำถามว่าถ้ากฎหมายเอาผิดคนผิดไม่ได้ ใครควรเป็นคนลงมือ',
    mod: { status: 'none' },
  },
  {
    id: 'y8',
