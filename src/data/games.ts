...
export const GAMES: Game[] = [
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/like-a-dragon-ishin-thai-mod/releases/download/v1.1/LikeADragonIshinThai-v1.1.zip',
      note: 'v1.1 (4 ก.ย. 2026) — แก้ภาพในจอทิปส์เป็นสี่เหลี่ยมขาว ชื่อศัตรูขึ้นเป็น ?????? และชื่อผู้พูด/ตัวเลือกตอบที่ยังเป็นอังกฤษ · ตั้งภาษาข้อความในเกมเป็น English',
      version: 'v1.1',
      updated: '2026-09-04',
    },
  },
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/judgment-thai/releases/download/v1.1.2/JudgmentThai-th-v1.1.2.zip',
      note: 'v1.1.2 (6 ก.ย. 2026) — แก้ตามรายงานผู้เล่น (คดี "จุดมืดมิดที่สุด" · ป้ายรับงานล้นกรอบ · คำติดอ่าง · แผงเดิมพันแบล็กแจ็ก) + กวาดตรวจคำแปลทั้งเกม ติดตั้งทับได้เลย เซฟเดิมใช้ต่อได้',
      version: 'v1.1.2',
      updated: '2026-09-06',
    },
  },
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.5/LostJudgmentThai-th-v1.0.5.zip',
      note: 'v1.0.5 (3 ก.ย. 2026) — แก้แผนผังชมรมไม่มีรูปตัวละคร, ชื่อคนในบทสนทนากลายเป็นสี่เหลี่ยม, คำอธิบายชมรมล้นกรอบ (โหมด School Stories) ติดตั้งทับได้เลย',
      version: 'v1.0.5',
      updated: '2026-09-03',
    },
  },
