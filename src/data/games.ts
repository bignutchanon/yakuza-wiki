...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    mod: {
      status: 'released',
      url: 'https://github.com/bignutchanon/lost-judgment-thai/releases/download/v1.0.11/LostJudgmentThai-th-v1.0.11.zip',
      nexus: 'https://www.nexusmods.com/lostjudgment/mods/800',
      note: 'v1.0.11 (24 ก.ย. 2026) — แปลบทพูด "I..." ที่ค้างเป็นอังกฤษ (สรรพนามตามเพศผู้พูดแต่ละฉาก) + ป้ายชื่อ/เมนูที่หลุดอีก 3 จุด ติดตั้งทับได้เลย',
      version: 'v1.0.11',
      updated: '2026-09-24',
    },
  },
