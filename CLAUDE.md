...
- **Y7 (Yakuza: Like a Dragon)** — released · v1.0.3 (16 ส.ค. 2026) · **ลิงก์ย้ายมา GitHub Releases 2 ก.ย. 2026** (`bignutchanon/yakuza7-thai-mod` tag `v1.0.3`, `LikeADragon7-Thai-v1.0.3.zip` 26.9 MB) แทน Drive (`1e_1ekuu…`) — ไฟล์เดียวกับตัวที่ทดสอบในเกมแล้ว เปลี่ยนแค่ชื่อไฟล์ให้เข้าชุด คนที่ลง v1.0.3 อยู่แล้วไม่ต้องโหลดซ้ำ (จึงไม่ได้เขียนข่าว) · ค้างอยู่: คำลงท้ายผิดเพศ 201 จุดที่ตรวจเจอรอบ 2 ก.ย. (ดึงเพศจากคิวเสียงพากย์) จะแก้ในรุ่นถัดไป · เนื้อหาแพตช์: แก้บั๊กมินิเกมบริหารธุรกิจ (ป้าย Leader/Member เลื่อน ดาวไม่ขึ้น) + ลิฟต์ทะลุแมป — ทั้งคู่มาจากเครื่องมือสร้างตาราง (reARMP) ไม่ใช่คำแปล รายละเอียดใน `yakuza-7-like-a-dragon-thai/HANDOFF.md`
